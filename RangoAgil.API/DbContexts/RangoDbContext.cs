...
public class RangoDbContext(DbContextOptions<RangoDbContext> options) : DbContext(options) // DbContext é a classe base para o contexto do banco de dados
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
       ...
       new { Id = 24, Nome = "Garam Masala" });
        ...
        // Aqui você pode configurar o mapeamento das entidades para as tabelas do banco de dados
        // modelBuilder.Entity<Rango>().ToTable("Rangos");
        // modelBuilder.Entity<Ingrediente>().ToTable("Ingredientes");

        // Configurações adicionais podem ser feitas aqui, como chaves primárias, relacionamentos, etc.
    }
}
